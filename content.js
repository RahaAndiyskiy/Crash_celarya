export const heroText = {
  title: 'Канцтовары, в которые ты влюбишься',
  subtitle: 'Яркий выбор для учебы, творчества и офисных идей. Стильный ассортимент для тех, кто любит жить в цвете.',
  ctaPrimary: 'Смотреть хиты',
  ctaSecondary: 'Каталог',
  approved: 'Одобрено Манулом',
};

export const features = [
  {
    id: 1,
    title: 'Модная канцелярия',
    description: 'Стикеры, ручки и блокноты в трендовых цветах, чтобы рабочее место радовало глаз.',
  },
  {
    id: 2,
    title: 'Мерч любимых блогеров',
    description: 'Фирменные наборы, блокноты и аксессуары от самых ярких лиц сети.',
  },
  {
    id: 3,
    title: 'Трендовые игрушки',
    description: 'Антистресс и милые гаджеты для отдыха между задачами.',
  },
];
