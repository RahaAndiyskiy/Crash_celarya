...
export default function Header() {
  ...
  return (
    <>
      <header className="fixed inset-x-0 top-0 z-10 mx-auto flex w-full max-w-3xl items-center justify-between rounded-xl bg-white/45 p-1 backdrop-blur-xl backdrop-saturate-150">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="inline-flex h-10 w-10 items-center justify-center rounded-xl bg-violet-700 text-white transition-colors hover:bg-violet-600 shadow-none border border-black md:hidden"
          >
            <svg className="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
