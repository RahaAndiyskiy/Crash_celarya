      ...
      <header className="sticky top-0 z-40 mb-3 flex items-center justify-between rounded-3xl border border-white/20 bg-white/45 p-2 shadow-soft backdrop-blur-xl backdrop-saturate-150">
        ...
        <div className="flex items-center gap-3">
          <button
            type="button"
            aria-label="Поиск"
            className="inline-flex h-11 w-11 items-center justify-center rounded-full border border-slate-200 bg-slate-100 text-slate-700 shadow-sm transition hover:bg-slate-200"
          >
          ...
          <button
            ...
            className="inline-flex h-11 w-11 items-center justify-center rounded-full border border-slate-200 bg-slate-100 text-slate-700 shadow-sm transition hover:bg-slate-200 md:hidden"
          >
            <svg className="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <button className="hidden rounded-full bg-violet-medium px-5 py-2 text-sm font-semibold text-white shadow-soft md:inline-flex">
            Войти
          </button>
        </div>
      </header>
