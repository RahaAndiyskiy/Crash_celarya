  ...
  return (
    <section id="contacts" className="grid gap-8 p-8 md:grid-cols-[1.1fr_0.9fr]">
      <div className="space-y-5">
        ...
        <h2 className="text-2xl font-semibold text-slate-900 sm:text-3xl">Заходи на чашку кофе или пиши нам</h2>
      ...
      <div className="rounded-[1.75rem] bg-slate-100 p-6 text-slate-500">
