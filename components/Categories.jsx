  ...
  return (
    <section id="categories" className="space-y-6">
      <div>
        ...
        <h2 className="mt-3 text-2xl font-semibold text-primary sm:text-3xl">Быстрый выбор по разделам</h2>
      </div>
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {items.map((category) => (
          <div key={category.id} className="flex items-center gap-4 rounded-[2rem] bg-white p-5">
